...
@pytest.mark.parametrize("value", [5, 50, 200, 300, 500, 501, 10_000, 20_000])
def test_agent_update_accepts_supported_model_step_limits(value: int) -> None:
    # Values above the platform cap (10000) pass the schema layer; the API
    # layer clamps them to 10000 with _clamped_fields feedback (see
