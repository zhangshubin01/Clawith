...
# NOTE: This literal route MUST stay above @router.put("/{tool_id}") below,
# otherwise "mcp-server" gets matched as a uuid.UUID tool_id and 422s with
# "Input should be a valid UUID, found 'm' at 1".
