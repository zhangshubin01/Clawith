...
PATCHES = [
    ...
    "ALTER TABLE chat_sessions ADD COLUMN IF NOT EXISTS is_group BOOLEAN DEFAULT FALSE",
    "ALTER TABLE chat_sessions ADD COLUMN IF NOT EXISTS group_name VARCHAR(200)",
    ...
    "ALTER TABLE chat_sessions ADD COLUMN IF NOT EXISTS is_primary BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE chat_sessions ADD COLUMN IF NOT EXISTS last_read_at_by_user TIMESTAMPTZ",
