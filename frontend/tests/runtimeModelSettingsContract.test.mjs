...
test('platform admins can select planning and compact platform models', () => {
...
test('runtime model choices are restricted to backend-provided candidates', () => {
  assert.match(source, /runtimeModelSettings\.candidates\.map/);
  assert.match(source, /暂无可用平台模型/);
