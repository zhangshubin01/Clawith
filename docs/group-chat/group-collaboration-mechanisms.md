...
边界说明：这里保证的是同一权威 Message Position 和不越界的公开语义来源；没有新增 cutoff 表、历史 compact 表、第二套 Group Context 框架或迁移。共享 rolling compact 仍由原有后台/terminal 流程维护，严格历史 snapshot 只属于对应 Run checkpoint。
